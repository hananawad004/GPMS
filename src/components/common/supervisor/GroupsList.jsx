    ...
    return (
        <Box sx={{ maxWidth: 1100 }}>
            <Box sx={{ mb: 3 }}>
                ...
                <Typography sx={{ color: t.textSecondary, fontSize: "0.9rem" }}>{groups.length} supervised teams · Spring 2025</Typography>
            </Box>
                        ...
                        {tab === 0 && (
                            <Stack spacing={2}>
                                ...
                                <Grid container spacing={1.5}>
                                    {[
                                        { label: "To Do", val: selected.tasks.todo, icon: <ViewKanbanOutlinedIcon />, color: t.textTertiary },
                                        { label: "In Progress", val: selected.tasks.inProgress, icon: <ViewKanbanOutlinedIcon />, color: t.accentTertiary },
                                        { label: "Done", val: selected.tasks.done, icon: <ViewKanbanOutlinedIcon />, color: t.success },
                                        { label: "Files", val: selected.files.total, icon: <FolderOutlinedIcon />, color: t.accentSecondary },
                                    ].map((item) => (
            ...
            {selected && (
                <Dialog open={sizeOpen} onClose={() => setSizeOpen(false)} maxWidth="xs" fullWidth>
                    ...
                    <DialogActions sx={{ px: 3, pb: 2.5 }}>
                        ...
                        <Button variant="contained" onClick={saveSize} sx={{ bgcolor: t.accentPrimary }}>Save</Button>
                    </DialogActions>
                </Dialog>
            )}
        </Box>
