import {
    Box, Paper, Typography, Stack, Button, Grid, MenuItem, Select, FormControl, InputLabel,
} from "@mui/material";
...
export default function Reports() {
    ...
    return (
        ...
        //                     <PieChart>
        //                         <Pie data={completionData} cx="50%" cy="50%" innerRadius={55} outerRadius={80}
        ...
        <Box sx={{ width: "100%" }}>
            ...
            >
                ...
                <Box sx={{ width: { xs: "100%", md: "48%" } }}>
                    <ChartCard
                        title="File Submissions & Meetings"
                        subtitle="Monthly activity — Spring 2025"
                    >
                        <ResponsiveContainer width="100%" height={240}>
                            <BarChart data={submissionsData} barSize={14} barCategoryGap="30%">
                                <CartesianGrid strokeDasharray="3 3" stroke={t.borderLight} vertical={false} />
                        ...
                        <ResponsiveContainer width="100%" height={220}>
                            <LineChart data={activityData}>
                                ...
                                <Line
                                    ...
                                    strokeWidth={2}
                                    dot={{ r: 4, fill: t.accentSecondary }}
                                    activeDot={{ r: 6 }}
                                />
                            </LineChart>
                        </ResponsiveContainer>
