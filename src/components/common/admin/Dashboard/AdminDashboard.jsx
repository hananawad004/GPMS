    ...
    return (
        <Box sx={{ maxWidth: 1100 }}>
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
                {STATS.map((s) => (
                    <Grid item xs={12} sm={6} lg={3} key={s.label}><StatCard s={s} /></Grid>
                ))}
            </Grid>
                                ...
                                {ALERTS.map((a, i) => (
                                    <Stack key={i} direction="row" alignItems="center" gap={1.5}
                                        ...
                                        <WarningAmberOutlinedIcon sx={{
                                            ...
                                            color: a.severity === "error" ? t.error : a.severity === "warning" ? t.warning : t.accentSecondary
                                        }} />
                                ...
                                {[
                                    ...
                                    <Grid item xs={6} key={a.label}>
                                        <Button variant="outlined" fullWidth onClick={() => navigate(a.path)}
                                            sx={{
                                                borderColor: t.borderLight, color: a.color, fontSize: "0.8rem", fontWeight: 600, py: 1.2, borderRadius: 2,
...
// import {
//     Box, Typography, Paper, Button, Stack, Avatar, Chip, LinearProgress
// } from "@mui/material";
// import { useTheme } from "@mui/material/styles";
// import { useNavigate } from "react-router-dom";
// import PeopleOutlineIcon from "@mui/icons-material/PeopleOutline";
...
//                 <Box>
//                     <Typography sx={{ fontSize: "0.72rem", fontWeight: 600, color: t.textTertiary }}>
//                         {s.label}
//                     </Typography>

//                     <Typography sx={{ fontSize: "2rem", fontWeight: 700, color: t.textPrimary }}>
//                         {s.value}
//                     </Typography>

//                     <Stack direction="row" alignItems="center" gap={0.5}>
//                         {s.up && <TrendingUpIcon sx={{ fontSize: 13, color: t.success }} />}
//                         <Typography sx={{ fontSize: "0.72rem", color: s.up ? t.success : t.textTertiary }}>
//                             {s.delta}
//                         </Typography>
//                     </Stack>
//                 </Box>

//                 <Box sx={{ p: 1.2, borderRadius: 2, bgcolor: `${s.color}15`, color: s.color }}>
//                     {s.icon}
//                 </Box>
//             </Stack>
//         </Paper>
...
//             <Box sx={{ mb: 3 }}>
//                 <Typography variant="h2" sx={{ color: t.textPrimary }}>
//                     Control Center
//                 </Typography>

//                 <Typography sx={{ color: t.textSecondary }}>
//                     System overview — Spring 2025
//                 </Typography>
//             </Box>
...
//                                         <Avatar sx={{ bgcolor: ROLE_CLR[u.role] }}>
//                                             {u.name.charAt(0)}
//                                         </Avatar>
...
//                                         <Chip label={STATUS_LBL[u.status]} size="small" />
